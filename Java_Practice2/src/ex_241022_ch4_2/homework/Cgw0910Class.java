...
class Pawn extends Cgw0910Class {
    public Pawn(boolean whiteTeam, int pieceColumn, int pieceRow) {
...
class Look extends Cgw0910Class {
    public Look(boolean whiteTeam, int pieceColumn, int pieceRow) {
...
class Knight extends Cgw0910Class {
    public Knight(boolean whiteTeam, int pieceColumn, int pieceRow) {
...
class Bishop extends Cgw0910Class {
    public Bishop(boolean whiteTeam, int pieceColumn, int pieceRow) {
...
class Queen extends Cgw0910Class {
    public Queen(boolean whiteTeam, int pieceColumn, int pieceRow) {
...
class King extends Cgw0910Class {
    public King(boolean whiteTeam, int pieceColumn, int pieceRow) {
