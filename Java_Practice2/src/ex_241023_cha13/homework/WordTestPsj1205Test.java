...
public class WordTestPsj1205Test extends JFrame {
	...
	public WordTestPsj1205Test() {
		...
		JButton inButton = new JButton("불러오기");
		...
		inButton.addActionListener(e -> inWord());
	...
	public void saveWord() {
		try {
	        ...
	        FileOutputStream fout = new FileOutputStream("c:\\Temp\\WordPsj1205.txt");
	        ObjectOutputStream oos = new ObjectOutputStream(fout);

	        // wordMeaningLabelMap 직렬화하여 저장
	        oos.writeObject(wordMeaningLabelMap);
	...
	public void inWord() {
	    try {
	        FileInputStream fin = new FileInputStream("c:\\Temp\\WordPsj1205.txt");
	        ObjectInputStream ois = new ObjectInputStream(fin);

	        // wordMeaningLabelMap에 저장된 데이터 불러오기
	        wordMeaningLabelMap = (Map<String, String>) ois.readObject();
	        ...
	        for (String word : wordMeaningLabelMap.keySet()) {
	            ...
	            wordLabel.addMouseListener(new MouseAdapter() {
	                ...
	                public void mouseClicked(MouseEvent e) {
	                    if (!showMeaning) {
	                        wordLabel.setText("뜻 : " + wordMeaningLabelMap.get(word));
	                        showMeaning = true;
	                    } else {
	                        wordLabel.setText(word);
	                        showMeaning = false;
